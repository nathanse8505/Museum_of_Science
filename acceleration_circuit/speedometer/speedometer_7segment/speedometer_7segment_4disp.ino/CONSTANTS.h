...
#define LE_CENTURIES (11) // Output Left (100th) digit LE (negative pulse) used as 10th
#define LE_DOZENS (9)
#define LE_UNITS (8) // Output right (10th) digit LE (negative pulse) used as units 
