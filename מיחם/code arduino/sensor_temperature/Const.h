 ...
 *                 RXD-|       |-Gnd  
 *                 RST-|       |-RST
 *                 GND-|       |-+5V  10k to A3 +10k to A2 + 10k to A1
 *                  D2-|       |-A7  
 *           BCD A  D3-|       |-A6  
 *           BCD B  D4-|       |-A5  
 *           BCD C  D5-|       |-A4  
 *           BCD D  D6-|       |-A3  ThermistorPin3 to gnd
 *    LE_CENTURIES  D7-|       |-A2  ThermistorPin2 to gnd
 *       LE_DOZENS  D8-|       |-A1  ThermistorPin1 to gnd
 *        LE_UNITS  D9-|       |-A0
 *                 D10-|       |-Ref
 *                 D11-|       |-3.3V   
...
const float A = 1.396993141e-03, B = 1.315326419e-04, C = 9.913222523e-07; //

int Vout1,Vout2,Vout3;
float R2;
float temperature_C_1,temperature_C_2,temperature_C_3;
