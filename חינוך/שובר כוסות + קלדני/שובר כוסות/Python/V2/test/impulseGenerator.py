...
class ImpulseGenerator(object):
    def __init__(self):
        ...
        self.impulse = gaussian(44100, std=4000) * 5
    ...
    def play_impulse(self):
        ...
        chunk = self.impulse.astype(numpy.float32).tobytes()
    ...
    def record(self):
        for i in range(CHUNKS_TO_RECORD):
            ...
            self.audio[i * CHUNK: (i + 1) * CHUNK] =numpy.frombuffer(audio_string, dtype=numpy.int16)
