...
Purpose: Class for detecting a drop for the Jumping Ring UI
"""
from consts import MIN_DROP_DISTANCE, VOLTAGE_AFTER_DROP


class DropDetector:
    def __init__(self, min_voltage_distance=MIN_DROP_DISTANCE, voltage_after_drop=VOLTAGE_AFTER_DROP):
        """
