...
extern const unsigned long BAUDERATE;                   // Serial communication baud rate
extern const unsigned long ACTIVATION_TIME;    // Time before the button can be pressed again (ms)
extern const unsigned long RESET_TIME_SECURE;  // Safety timeout: stops motor if micro switch is stuck (ms)
extern const unsigned long SET_DAY; // 5 hour in ms to log a day passed
